...
@interface ECRoom ()
@property (nonatomic)  NSInteger  localWidth;
@property (nonatomic)  NSInteger  localHeight;
@property (nonatomic)  NSInteger  localFps;
@property (nonatomic)  NSInteger  localBandwidthKbps;
@end
...
- (void)publish:(ECStream *)stream {
    ...
    publishClient.maxBitrate = [NSNumber numberWithInteger:_localBandwidthKbps];
...
- (void)setWidth:(NSInteger)width Height:(NSInteger)height Fps:(NSInteger)fps Bandwidth:(NSInteger)bandwidth {
    _localWidth = width;
    _localHeight = height;
    _localFps = fps;
    _localBandwidthKbps = bandwidth;
}
