...
static NSString * _Nonnull const kStreamOptionExternalVideoSource    = @"externalVideoSource";

@protocol ECStreamDelegate
@optional
- (void) didChangeVideoSize:(CGSize)size streamId:(NSString * _Nullable)streamId streamAttributes:(NSDictionary * _Nonnull)streamAttributes;
@end
 ...
 */
@interface ECStream: NSObject<RTCEAGLVideoViewDelegate>
...
- (void)pushExternalVideoFrame:(RTCVideoFrame *_Nonnull)frame;
...
@property (nonatomic, weak)  id<ECStreamDelegate> _Nullable delegate;
